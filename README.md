...
I am a versatile developer with expertise spanning both high-level and low-level programming. My skills in Python enable me to build scalable web applications and data-driven solutions, while my proficiency in Rust and Assembly gives me the ability to optimize performance, write systems-level code, and ensure robustness in critical areas of development. I am passionate about pushing the boundaries of technology and continuously learning new tools and frameworks to contribute to impactful and innovative projects.
